    ...
    timeline: [
      {
        step: 1,
        title: "Order Placed",
        description: "Your vehicle transport order has been confirmed",
        time: "1 Nov 2025, 10:00 AM",
        completed: true,
      },
      {
        step: 2,
        title: "Vehicle Picked Up",
        description: "Vehicle picked up from Mumbai, MH",
        time: "1 Nov 2025, 2:00 PM",
        completed: true,
      },
      {
        step: 3,
        title: "In Transit",
        description: "Currently in Nagpur, MH",
        time: "3 Nov 2025, 11:30 AM",
        completed: true,
      },
      {
        step: 4,
        title: "Out for Delivery",
        description: "Vehicle will be delivered soon",
        time: "Pending",
        completed: false,
      },
      {
        step: 5,
        title: "Delivered",
        description: "Vehicle to be delivered to Nagpur, MH",
        time: "Pending",
        completed: false,
      },
    ],
  ...
  TRK67890: {
    ...
    timeline: [
      ...
      },
      {
        step: 5,
        title: "Delivered",
        description: "Vehicle to be delivered to Kolkata, WB",
        time: "Pending",
        completed: false,
      },
    ],
    ...
    timeline: [
      {
        ...
        title: "Order Placed",
        description: "Your vehicle transport order has been confirmed",
        time: "28 Oct 2025, 11:00 AM",
        completed: true,
      },
      {
        step: 2,
        title: "Vehicle Picked Up",
        description: "Vehicle picked up from Pune, MH",
        time: "28 Oct 2025, 3:00 PM",
        completed: true,
      },
      {
        step: 3,
        title: "In Transit",
        description: "Vehicle transported across states",
        time: "30 Oct 2025",
        completed: true,
      },
      {
        ...
        time: "1 Nov 2025, 9:00 AM",
        completed: true,
      },
      {
        step: 5,
        title: "Delivered",
        description: "Vehicle delivered to Chennai, TN",
        time: "1 Nov 2025, 2:30 PM",
        completed: true,
      },
    ],
  },
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  trackingForm.addEventListener("submit", function (e) {
    ...
    if (
      window.voiceSearch &&
      window.voiceSearch.lastVoiceInput === trackingId
    ) {
