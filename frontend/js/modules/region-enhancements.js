...
function initCityCounter() {
  ...
  function updateCounter() {
    ...
    const visibleCards = regionGrid.querySelectorAll('.region-card.enhanced.visible, .region-card.enhanced:not([data-index])');
  ...
  // Update periodically (for dynamic changes)
